...
using SubjectClass = Capibara.Converters.BottomMarginConverter;

namespace Capibara.Test.Converters.BottomMarginConverter
{
    [TestFixture]
    public class Convert
    {
        [TestCase(Device.Android, 1024, 0)]
        [TestCase(Device.iOS, 1024, 0)]
        [TestCase(Device.iOS, 2436, 34)]
