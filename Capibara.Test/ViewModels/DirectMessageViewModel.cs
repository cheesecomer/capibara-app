...
using SubjectViewModel = Capibara.ViewModels.DirectMessageViewModel;

namespace Capibara.Test.ViewModels.DirectMessageViewModel
{
    [TestFixture]
    public class ShowProfileCommandTest : ViewModelTestBase
    {
        ...
        {
            var model = new DirectMessage { Sender = new User().BuildUp(this.Container), Content = string.Empty }.BuildUp(this.Container);
